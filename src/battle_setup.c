...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_NONE, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MAP_MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_YUKI_ABYSS, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MAP_MT_CHIMNEY),
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_ROXANNE_3, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, MAP_RUSTBORO_CITY),
...
void BattleSetup_StartTrainerBattle(void)
{
    ...
    else
    {
        ...
        else if (GetTrainerBattleMode() == TRAINER_BATTLE_DOUBLE
              || GetTrainerBattleMode() == TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE
