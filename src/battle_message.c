...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNREVERTEDTOPRIMAL]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Primal Reversion! It reverted to its primal form!"),
...
const u16 gStartingStatusStringIds[B_MSG_STARTING_STATUS_COUNT] =
{
    ...
    [B_MSG_SET_HAIL]             = STRINGID_STARTEDHAIL,
    [B_MSG_SET_SANDSTORM]        = STRINGID_SANDSTORMBREWED,
    [B_MSG_SET_FOG]              = STRINGID_FOGCREPTUP,
