...
$(ALL_TUTORS_JSON): $(wildcard $(DATA_ASM_SUBDIR)/scripts/*.inc) $(wildcard $(DATA_ASM_SUBDIR)/maps/*/scripts.inc) $(LEARNSET_HELPERS_DIR)/make_tutors.py | $(LEARNSET_HELPERS_BUILD_DIR)
